...
function ajaxSearch() {
    ...
    $.ajax({
        type: Player.method,
        url: "/search",
        data: "count=" + Player.loadCount + "&source=" + rem.source + "&page=" + rem.loadPage + "&keyword=" + rem.wd,
        dataType : "json",
        ...
        success: function(jsonData){
            ...
            for (var i = 0; i < jsonData.length; i++) {
                ...
                tempItem =  {
                    ...
                    source: jsonData[i].dataSource, // 音乐来源
                    url_id: jsonData[i].url_id,    // 链接ID
                    pic_url: jsonData[i].picId,    // 封面ID
                    url: jsonData[i].musicUrl,// mp3链接
                    lyric_id: jsonData[i].lyric,  // 歌词ID
                    pic: null    // 专辑图片
                };
